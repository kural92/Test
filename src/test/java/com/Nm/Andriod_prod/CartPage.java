...
public class CartPage extends MobileBaseClass {
...
//*****************************************************************Cart Page	*********************************************************
	...
	public void CartPageScenario1() throws Throwable {
		...
		logger.log(Status.PASS, "*************Cart Page Scenario1********************" );
...
//Test Case 3 :Verify Cart page when the Total amount is more than greater than 150 and less than or equal to 500
	@Test(enabled = true,retryAnalyzer=RetryAnalyzer.class)
		...
		public void CartPageScenario3() throws Throwable {
			...
			logger.log(Status.PASS, "*************Cart Page Scenario 3********************" );
...
//Test case 4: Verify Cart page when the Total amount when NMS wallet is applied
	...
	@Test(enabled = true,retryAnalyzer=RetryAnalyzer.class)
		...
		public void CartPageScenario4() throws Throwable {
			...
			logger.log(Status.PASS, "*************Cart Page Scenario 4********************" );
	...
	//Wallet
			...
			WebElement Nmswallet_text = driver.findElement(By.id("com.NetmedsMarketplace.Netmeds:id/tv_nms_super_cash_description"));
	...
	//NMS cash cal calculation		
			
			if (!(driver.findElements(By.id("com.NetmedsMarketplace.Netmeds:id/cart_nmsWallet")).size()==0))
			{
				Wallet = driver.findElement(By.id("com.NetmedsMarketplace.Netmeds:id/cart_nmsWallet")).getText();
				System.out.println(Wallet);
				logger.log(Status.PASS, "Wallet amount is "+ Wallet);
				
				String[] Wallet_amt = Wallet.split("₹ -"); 	
				System.out.println(Wallet_amt);
				
				Wallet = Wallet_amt[1].toString();
				System.out.println(Wallet);
				
				 total_Wallet_amt = Float.parseFloat(Wallet);
				 
				System.out.println("total wallet amount is ===" +Wallet);
	...
	//Total Amount//	
		...
		//Mrp charge(net charge) calculation//
				...
				if (mrpcharge<=150.00 && dlcharge.trim().equals("50.00")) {
				 	...
				 	Netcharge = (mrpcharge +delcharge)-total_Wallet_amt;
			    }
